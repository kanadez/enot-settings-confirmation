                ...
                <form class="bg-white px-8 pt-6 pb-8 mb-4">
                    <div class="flex items-start mb-2">
                        <div class="w-1/4 pt-1">
                            <label class="block text-gray-500 text-sm md:text-right mb-1 md:mb-0 pr-4" for="code">
                                Введите код
                            </label>
                        </div>
                        <div class="w-3/4">
                            <input class="" v-model="params.code" id="code" type="number" placeholder="Введите код подтверждения">
                        </div>
                    </div>
